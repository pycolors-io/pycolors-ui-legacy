...
<Preview>
  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
    ...
    {/* success */}
    <div className="rounded-md border p-4">
      <div className="text-xs font-medium mb-2 text-muted-foreground">success</div>
      <div className="h-10 rounded bg-success" />
    </div>

    {/* warning */}
    <div className="rounded-md border p-4">
      <div className="text-xs font-medium mb-2 text-muted-foreground">warning</div>
...
Color tokens belong to the **design system**.
UI components only **consume** them — they never redefine them.
